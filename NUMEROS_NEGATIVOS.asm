           ;Determine la cantidad de números negativos (Bit más significativo en uno)
           ;en un bloque de datos determinado. La longitud del bloque está en la
           ;dirección $0091 y el bloque comienza en la dirección $0092. Coloque el
           ;resultado en la dirección $0090.
